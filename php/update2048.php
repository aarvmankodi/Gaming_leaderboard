...
$sql_check = "SELECT * FROM g2048 WHERE player_name = ?";
...
if ($result_check->num_rows > 0) {
    ...
    if ($row['highest_score'] < $highest_score) {
        $sql_update = "UPDATE g2048 SET highest_score = ? WHERE player_name = ?";
    ...
    $sql_insert = "INSERT INTO g2048 (player_name, highest_score) VALUES (?, ?)";
